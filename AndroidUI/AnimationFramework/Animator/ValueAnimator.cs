...
namespace AndroidUI.AnimationFramework.Animator
{
     ...
     * </div>
     */
    public class ValueAnimator : Animator, AnimationHandler.AnimationFrameCallback
    {
        private const string TAG = "ValueAnimator";
        ...
        private static readonly TimeInterpolator sDefaultInterpolator = new AccelerateDecelerateInterpolator();
         ...
         */
        private bool mStartListenersCalled = false;
         ...
         */
        private bool mAnimationEndRequested = false;
         ...
         */
        private bool mSuppressSelfPulseRequested = false;
         ...
         */
        List<AnimatorUpdateListener> mUpdateListeners = null;

        /**
         * The property/value sets being animated.
         */
        internal PropertyValuesHolder[] mValues;

        /**
         * A hashmap of the PropertyValuesHolder objects. This map is used to lookup animated values
         * by property name during calls to getAnimatedValue(String).
         */
        internal Dictionary<string, PropertyValuesHolder> mValuesMap;
         ...
         *
         * @return bool Whether animators are currently enabled. The default value is
         * <code>true</code>.
         */
         ...
         */
        public static ValueAnimator ofInt(Context context, params int[] values)
        {
            ValueAnimator anim = new(context);
         ...
         * @return A ValueAnimator object that is set up to animate between the given values.
         */
        public static ValueAnimator ofArgb(Context context, params int[] values)
        {
            ValueAnimator anim = new(context);
            anim.setIntValues(values);
         ...
         * @return A ValueAnimator object that is set up to animate between the given values.
         */
        public static ValueAnimator ofFloat(Context context, params float[] values)
        {
            ValueAnimator anim = new(context);
         ...
         * @return A ValueAnimator object that is set up to animate between the given values.
         */
        public static ValueAnimator ofPropertyValuesHolder(Context context, params PropertyValuesHolder[] values)
        {
            ValueAnimator anim = new(context);
         ...
         * @return A ValueAnimator object that is set up to animate between the given values.
         */
        public static ValueAnimator ofObject(Context context, ITypeEvaluator evaluator, params object[] values)
        {
            ValueAnimator anim = new(context);
         ...
         */
        virtual public void setObjectValues(params object[] values)
        {
            if (values == null || values.Length == 0)
            {
                return;
         ...
         */
        public void setValues(params PropertyValuesHolder[] values)
        {
            int numValues = values.Length;
            mValues = values;
            mValuesMap = new Dictionary<string, PropertyValuesHolder>(numValues);
            for (int i = 0; i < numValues; ++i)
            {
                PropertyValuesHolder valuesHolder = values[i];
                mValuesMap[valuesHolder.getPropertyName()] = valuesHolder;
            }
            // New property/values/target should cause re-initialization prior to starting
            mInitialized = false;
        }
        ...
        public void setCurrentFraction(float fraction)
        {
            ...
            if (isPulsingInternal())
            {
                ...
                long currentTime = AnimationUtils.currentAnimationTimeMillis(context);
        ...
        public long getCurrentPlayTime()
        {
            ...
            return (long)((AnimationUtils.currentAnimationTimeMillis(context) - mStartTime) / durationScale);
        }
        ...
        {
            PropertyValuesHolder valuesHolder = mValuesMap.GetValueOrDefault(propertyName, null);
        ...
        public void addUpdateListener(AnimatorUpdateListener listener)
        {
            ...
            {
                mUpdateListeners = new List<AnimatorUpdateListener>();
            }
         ...
         */
        public void setEvaluator(ITypeEvaluator value)
        {
        ...
        private void notifyStartListeners()
        {
            ...
            {
                List<AnimatorListener> tmpListeners = new(mListeners);
                int numListeners = tmpListeners.Count;
                for (int i = 0; i < numListeners; ++i)
                {
                    tmpListeners.ElementAt(i).onAnimationStart(this, mReversing);
                }
            }
        ...
        internal override void startWithoutPulsing(bool inReverse)
        {
        ...
        public void cancel()
        {
            ...
            if ((mStarted || mRunning) && mListeners != null)
            {
                ...
                List<AnimatorListener> tmpListeners = new(mListeners);
                foreach (AnimatorListener listener in tmpListeners)
                {
        ...
        public void resume()
        {
            if (Looper.myLooper(context) == null)
            {
                throw new Exception("Animators may only be resumed from the same " +
        ...
        private void endAnimation()
        {
            ...
            mPaused = false;
            bool notify = (mStarted || mRunning) && mListeners != null;
            if (notify && !mRunning)
            {
                // If it's not yet running, then start listeners weren't called. Call them now.
                notifyStartListeners();
         ...
         */
        protected virtual string getNameForTrace()
        {
            return "animator";
        }
            ...
            if (mRunning)
            {
                ...
                else if (newIteration && !lastIterationFinished)
                {
                    ...
                    if (mListeners != null)
                    {
                        ...
                        for (int i = 0; i < numListeners; ++i)
                        {
                            mListeners.ElementAt(i).onAnimationRepeat(this);
                        }
                    }
                }
         ...
         */
        internal override void skipToEndValue(bool inReverse)
        {
            initAnimation();
        ...
        public bool doAnimationFrame(long frameTime)
        {
            ...
            long currentTime = Math.Max(frameTime, mStartTime);
         ...
         */
        virtual internal void animateValue(float fraction)
        {
            ...
            if (mUpdateListeners != null)
            {
                int numListeners = mUpdateListeners.Count;
                for (int i = 0; i < numListeners; ++i)
                {
                    mUpdateListeners.ElementAt(i).onAnimationUpdate(this);
                }
            }
        }
        ...
        {
            ValueAnimator anim = (ValueAnimator)base.Clone();
            anim.context = context;
            if (mUpdateListeners != null)
            {
                anim.mUpdateListeners = new List<AnimatorUpdateListener>(mUpdateListeners);
            }
            ...
            if (oldValues != null)
            {
                ...
                anim.mValuesMap = new Dictionary<string, PropertyValuesHolder>(numValues);
                for (int i = 0; i < numValues; ++i)
                {
                    PropertyValuesHolder newValuesHolder = oldValues[i].Clone();
                    anim.mValues[i] = newValuesHolder;
                    anim.mValuesMap[newValuesHolder.getPropertyName()] = newValuesHolder;
                }
            }
            return anim;
        }
         ...
         * @hide
         */
        public static int getCurrentAnimationsCount(Context context)
        {
            return AnimationHandler.getAnimationCount(context);
        }

        override
        public string ToString()
        {
            string returnVal = "ValueAnimator@" + GetHashCode().toHexString();
            if (mValues != null)
            {
         ...
         */
        override
        public void setAllowRunningAsynchronously(bool mayRunAsync)
        {
         ...
         * @hide
         */
        internal AnimationHandler getAnimationHandler()
        {
            return mAnimationHandler != null ? mAnimationHandler : AnimationHandler.getInstance(context);
        }
         ...
         * @hide
         */
        internal void setAnimationHandler(AnimationHandler animationHandler)
        {
