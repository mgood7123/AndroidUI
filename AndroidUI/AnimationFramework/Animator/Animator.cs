...
namespace AndroidUI.AnimationFramework.Animator
{
    ...
    public abstract class Animator : Utils.ICloneable
    {
         ...
         */
        public const long DURATION_INFINITE = -1;
        /**
         * The set of listeners to be sent events through the life of an animation.
         */
        protected List<AnimatorListener> mListeners = null;

        /**
         * The set of listeners to be sent pause/resume events through the life
         * of an animation.
         */
        protected List<AnimatorPauseListener> mPauseListeners = null;
        ...
        virtual public void pause()
        {
            if (isStarted() && !mPaused)
            {
                ...
                {
                    List<AnimatorPauseListener> tmpListeners = new(mPauseListeners);
                    int numListeners = tmpListeners.Count;
                    for (int i = 0; i < numListeners; ++i)
                    {
                        tmpListeners.ElementAt(i).onAnimationPause(this);
                    }
                }
            }
        }
        ...
        virtual public void resume()
        {
            if (mPaused)
            {
                ...
                if (mPauseListeners != null)
                {
                    ...
                    for (int i = 0; i < numListeners; ++i)
                    {
                        tmpListeners.ElementAt(i).onAnimationResume(this);
                    }
                }
            }
        }
         ...
         */
        virtual public long getTotalDuration()
        {
         ...
         */
        public abstract void setInterpolator(Interpolators.TimeInterpolator value);
         ...
         */
        virtual public Interpolators.TimeInterpolator getInterpolator()
        {
            return null;
        }
        ...
        public void addListener(AnimatorListener listener)
        {
            if (mListeners == null)
            {
                mListeners = new List<AnimatorListener>();
            }
        ...
        public void addPauseListener(AnimatorPauseListener listener)
        {
            if (mPauseListeners == null)
            {
                mPauseListeners = new List<AnimatorPauseListener>();
            }
         ...
         * @hide
         */
        internal void setChangingConfigurations(int configs)
        {
         ...
         * @hide
         */
        internal void appendChangingConfigurations(int configs)
        {
            mChangingConfigurations |= configs;
        }
        ...
        virtual public Animator Clone()
        {
            ...
            {
                anim.mConstantState = new AnimatorConstantState(anim);
            }
            if (mListeners != null)
            {
                anim.mListeners = new List<AnimatorListener>(mListeners);
            }
            if (mPauseListeners != null)
            {
                anim.mPauseListeners = new List<AnimatorPauseListener>(mPauseListeners);
            }
            return anim;
        }
         ...
         */
        virtual public void setupStartValues()
        {
        }
         ...
         * information (such as a target object) to gather these values.
         */
        virtual public void setupEndValues()
        {
        }
         ...
         * @hide
         */
        virtual public bool canReverse()
        {
            return false;
        }
        ...
        internal virtual bool pulseAnimationFrame(long frameTime)
        {
         ...
         */
        virtual internal void startWithoutPulsing(bool inReverse)
        {
            if (inReverse)
            {
                reverse();
         ...
         */
        internal virtual void skipToEndValue(bool inReverse) { }
         ...
         * Internal use only.
         */
        internal virtual void animateBasedOnPlayTime(long currentPlayTime, long lastPlayTime, bool inReverse) { }
        ...
        public interface AnimatorListener
        {
             ...
             */
            public virtual void onAnimationStart(Animator animation, bool isReverse)
            {
             ...
             * @param isReverse Whether the animation is playing in reverse.
             */
            public virtual void onAnimationEnd(Animator animation, bool isReverse)
            {
         ...
         */
        private class AnimatorConstantState : ConstantState<Animator>
        {
