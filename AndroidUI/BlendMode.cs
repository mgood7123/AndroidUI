...
namespace AndroidUI
{
    public class BlendMode
    {
         ...
         * </p>
         */
        public const int COLOR_DODGE = 18;
         ...
         * </p>
         */
        public const int COLOR_BURN = 19;
         ...
         * </p>
         */
        public const int HARD_LIGHT = 20;
         ...
         * </p>
         */
        public const int SOFT_LIGHT = 21;
         ...
         * </p>
         */
        public const int DIFFERENCE = 22;
         ...
         * </p>
         */
        public const int SATURATION = 26;
         ...
         * </p>
         */
        public const int LUMINOSITY = 28;

        private static readonly BlendMode[] BLEND_MODES = {
        CLEAR, SRC, DST, SRC_OVER, DST_OVER, SRC_IN, DST_IN, SRC_OUT, DST_OUT,
        SRC_ATOP, DST_ATOP, XOR, DARKEN, LIGHTEN, MODULATE, SCREEN, PLUS, OVERLAY
    };
        ...
        public static PorterDuff.Mode blendModeToPorterDuffMode(BlendMode mode)
        {
            if (mode != null)
            {
                switch (mode.mXfermode.porterDuffMode)
                {
                    case CLEAR:
        ...
        private readonly Xfermode mXfermode;
