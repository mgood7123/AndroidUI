...
namespace AndroidUI
{
    ...
    public sealed class CamUtils
    {
        ...
        internal static readonly float[][] XYZ_TO_CAM16RGB = {
        ...
        internal static readonly float[][] CAM16RGB_TO_XYZ = {
            new float[] {1.86206786f, -1.01125463f, 0.14918677f},
            new float[] {0.38752654f, 0.62144744f, -0.00897398f},
            new float[] {-0.01584150f, -0.03412294f, 1.04996444f}
        };
        ...
        internal static readonly float[] WHITE_POINT_D65 = { 95.047f, 100.0f, 108.883f };
        ...
        internal static readonly float[][] SRGB_TO_XYZ = {
            new float[] {0.41233895f, 0.35762064f, 0.18051042f},
            new float[] {0.2126f, 0.7152f, 0.0722f},
            new float[] {0.01932141f, 0.11916382f, 0.95034478f}
        };

        internal static unsafe int intFromLstar(float lstar)
        {
            if (lstar < 1)
            {
                return reinterpret_cast<int>(0xff000000);
            }
            else if (lstar > 99)
            {
                return reinterpret_cast<int>(0xffffffff);
            }
            ...
            return ColorUtils.XYZToColor(xT * WHITE_POINT_D65[0],
        ...
        internal static float lstarFromY(float y)
        {
            ...
            {
                yIntermediate = (float)MathUtils.cbrt(y);
            }
            return 116.0f * yIntermediate - 16.0f;
        }

        internal static float yFromInt(int argb)
        {
        ...
        internal static float[] xyzFromInt(int argb)
        {
            float r = linearized(Color.red(argb));
            float g = linearized(Color.green(argb));
            float b = linearized(Color.blue(argb));
        ...
        internal static float linearized(int rgbComponent)
        {
