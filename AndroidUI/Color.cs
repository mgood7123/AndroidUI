...
namespace AndroidUI
{
    ...
    public class Color
    {
        public static readonly int BLACK = reinterpret_cast<int>(0xFF000000);
        public static readonly int DKGRAY = reinterpret_cast<int>(0xFF444444);
        public static readonly int GRAY = reinterpret_cast<int>(0xFF888888);
        public static readonly int LTGRAY = reinterpret_cast<int>(0xFFCCCCCC);
        public static readonly int WHITE = reinterpret_cast<int>(0xFFFFFFFF);
        public static readonly int RED = reinterpret_cast<int>(0xFFFF0000);
        public static readonly int GREEN = reinterpret_cast<int>(0xFF00FF00);
        public static readonly int BLUE = reinterpret_cast<int>(0xFF0000FF);
        public static readonly int YELLOW = reinterpret_cast<int>(0xFFFFFF00);
        public static readonly int CYAN = reinterpret_cast<int>(0xFF00FFFF);
        public static readonly int MAGENTA = reinterpret_cast<int>(0xFFFF00FF);
        public const int TRANSPARENT = 0;

        private readonly float[] mComponents;
        ...
        public float[] getComponents(float[] components)
        {
            ...
            Arrays.arraycopy(mComponents, 0, components, 0, mComponents.Length);
            return components;
        }
        ...
        public float luminance()
        {
            ...
            double r = eotf.apply(mComponents[0]);
            double g = eotf.apply(mComponents[1]);
            double b = eotf.apply(mComponents[2]);
         ...
         */
        public static bool isSrgb(long color)
        {
         ...
         * @see ColorSpace#isWideGamut()
         */
        public static bool isWideGamut(long color)
        {
         ...
         * @see #isWideGamut(long)
         */
        public static bool isInColorSpace(long color, ColorSpace colorSpace)
        {
        ...
        public static long convert(long color, ColorSpace colorSpace)
        {
            ...
            float b = blue(color);
            float a = alpha(color);
            ColorSpace source = Color.colorSpace(color);
            return convert(r, g, b, a, source, colorSpace);
        }
        ...
        public static float luminance(long color)
        {
            ...
            double r = eotf.apply(red(color));
            double g = eotf.apply(green(color));
            double b = eotf.apply(blue(color));
        ...
        public static int rgb(
                ...
                int blue)
        {
            return (int)(0xff000000 | (uint)(red << 16 | green << 8 | blue));
        }
        ...
        public static float luminance(int color)
        {
            ...
            double r = eotf.apply(red(color) / 255.0);
            double g = eotf.apply(green(color) / 255.0);
            double b = eotf.apply(blue(color) / 255.0);
        ...
        public static int parseColor(String colorString)
        {
            ...
            {
                int color;
                if (sColorNameMap.TryGetValue(colorString.ToLowerInvariant(), out color))
                {
                    return color;
                }
            }
...
*/
        ...
        static Color()
        {
            ...
            sColorNameMap.Add("black", BLACK);
            sColorNameMap.Add("darkgray", DKGRAY);
            sColorNameMap.Add("gray", GRAY);
            sColorNameMap.Add("lightgray", LTGRAY);
            sColorNameMap.Add("white", WHITE);
            sColorNameMap.Add("red", RED);
            sColorNameMap.Add("green", GREEN);
            sColorNameMap.Add("blue", BLUE);
            sColorNameMap.Add("yellow", YELLOW);
            sColorNameMap.Add("cyan", CYAN);
            sColorNameMap.Add("magenta", MAGENTA);
            sColorNameMap.Add("aqua", reinterpret_cast<int>(0xFF00FFFF));
            sColorNameMap.Add("fuchsia", reinterpret_cast<int>(0xFFFF00FF));
            sColorNameMap.Add("darkgrey", DKGRAY);
            sColorNameMap.Add("grey", GRAY);
            sColorNameMap.Add("lightgrey", LTGRAY);
            sColorNameMap.Add("lime", reinterpret_cast<int>(0xFF00FF00));
            sColorNameMap.Add("maroon", reinterpret_cast<int>(0xFF800000));
            sColorNameMap.Add("navy", reinterpret_cast<int>(0xFF000080));
            sColorNameMap.Add("olive", reinterpret_cast<int>(0xFF808000));
            sColorNameMap.Add("purple", reinterpret_cast<int>(0xFF800080));
            sColorNameMap.Add("silver", reinterpret_cast<int>(0xFFC0C0C0));
