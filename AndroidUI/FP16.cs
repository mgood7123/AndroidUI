...
public sealed class FP16
    ...
    public const int SIZE = 16;
         ...
         * @hide
         */
    public const short EPSILON = (short)0x1400;
    ...
    public const int MAX_EXPONENT = 15;
         ...
         * @hide
         */
    public const int MIN_EXPONENT = -14;
         ...
         * @hide
         */
    public const short LOWEST_VALUE = unchecked((short)0xfbff);
        /**
         * Maximum positive finite value a half-precision float may have.
         *
         * @hide
         */
    public const short MAX_VALUE = (short)0x7bff;
        /**
         * Smallest positive normal value a half-precision float may have.
         *
         * @hide
         */
    public const short MIN_NORMAL = (short)0x0400;
        /**
         * Smallest positive non-zero value a half-precision float may have.
         *
         * @hide
         */
    public const short MIN_VALUE = (short)0x0001;
        /**
         * A Not-a-Number representation of a half-precision float.
         *
         * @hide
         */
    public const short NaN = (short)0x7e00;
        /**
         * Negative infinity of type half-precision float.
         *
         * @hide
         */
    public const short NEGATIVE_INFINITY = unchecked((short)0xfc00);
        /**
         * Negative 0 of type half-precision float.
         *
         * @hide
         */
        public const short NEGATIVE_ZERO = unchecked((short)0x8000);
        /**
         * Positive infinity of type half-precision float.
         *
         * @hide
         */
        public const short POSITIVE_INFINITY = (short)0x7c00;
        /**
         * Positive 0 of type half-precision float.
         *
         * @hide
         */
    public const short POSITIVE_ZERO = (short)0x0000;
         ...
         * @hide
         */
    public const int SIGN_SHIFT = 15;
         ...
         * @hide
         */
    public const int EXPONENT_SHIFT = 10;
    ...
    public const int SIGN_MASK = 0x8000;
    ...
    public const int SHIFTED_EXPONENT_MASK = 0x1f;
    ...
    public const int SIGNIFICAND_MASK = 0x3ff;
    ...
    public const int EXPONENT_SIGNIFICAND_MASK = 0x7fff;
    ...
    public const int EXPONENT_BIAS = 15;
        ...
        private const int FP32_SHIFTED_EXPONENT_MASK = 0xff;
        ...
        private const int FP32_DENORMAL_MAGIC = 126 << 23;
        private static readonly float FP32_DENORMAL_FLOAT = FP32_DENORMAL_MAGIC.BitsToFloat();
    ...
    public static bool isNaN(short h)
        {
            return (h & EXPONENT_SIGNIFICAND_MASK) > POSITIVE_INFINITY;
        }
    ...
    public static float toFloat(short h)
        {
            ...
            { // Denormal or 0
                if (m != 0)
                {
                    ...
                    float o = (FP32_DENORMAL_MAGIC + m).BitsToFloat();
            ...
            int out_ = (s << 16) | (outE << FP32_EXPONENT_SHIFT) | outM;
            return out_.BitsToFloat();
        }
