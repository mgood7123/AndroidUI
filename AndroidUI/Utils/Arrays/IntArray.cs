...
namespace AndroidUI.Utils.Arrays
{
     ...
     * @hide
     */
    public class IntArray : ICloneable
    {
        private const int MIN_CAPACITY_INCREMENT = 12;
        ...
        private IntArray(int[] array, int size)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(nameof(size), "size must be between zero and array.Length (" + array.Length + ")");
            }
        }
        ...
        {
            return new IntArray(array, array == null ? 0 : array.Length);
        }
        ...
        public void resize(int newSize)
        {
            if (newSize < 0)
            {
                throw new Exceptions.IllegalArgumentException("size cannot be negative");
            }
        ...
        public void add(int index, int value)
        {
            ...
            if (rightSegment != 0)
            {
                ...
                Arrays.arraycopy(mValues, index, mValues, index + 1, rightSegment);
            }
        ...
        {
            return Arrays.binarySearch(mValues, mSize, value);
        }
        ...
        public void addAll(IntArray values)
        {
            ...
            Arrays.arraycopy(values.mValues, 0, mValues, mSize, count);
            mSize += count;
        }
        ...
        public void addAll(int[] values)
        {
            ...
            Arrays.arraycopy(values, 0, mValues, mSize, count);
            mSize += count;
        }
        ...
        private void ensureCapacity(int count)
        {
            ...
            {
                int targetCap = currentSize + (currentSize < MIN_CAPACITY_INCREMENT / 2 ?
                        MIN_CAPACITY_INCREMENT : currentSize >> 1);
                int newCapacity = targetCap > minCapacity ? targetCap : minCapacity;
                int[] newValues = new int[newCapacity];
                Arrays.arraycopy(mValues, 0, newValues, 0, currentSize);
                mValues = newValues;
            }
        }
        ...
        {
            IntArray clone = (IntArray)ICloneable.Clone(this);
            clone.mValues = (int[])mValues.Clone();
            return clone;
        }
