...
namespace AndroidUI.Utils.Arrays
{
    public static class Arrays
    {
        ...
        public static readonly object[] EMPTY_OBJECT_ARRAY = EmptyArray.OBJECT;
        ...
        public static unsafe void fill(int[] mValues, int fromIndex, int toIndex, int v)
        {
            ...
            fixed (int* p = mValues)
            {
                Functions.memset(p + fromIndex, v, (nuint)(toIndex - fromIndex));
            }
        }
        ...
        public static unsafe T[] FromNative<T>(void* ptr, int length) where T : unmanaged
        {
            ...
            fixed (T* p1 = array)
            {
                Functions.memcpy(p1, ptr, (nuint)(length * sizeof(T)));
            }
            return array;
        }
