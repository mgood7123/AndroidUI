...
namespace AndroidUI.Utils.Graphics
{
    ...
    public sealed class Frame
    {
        ...
        public static readonly Frame DEFAULT =
            make(
                    CamUtils.WHITE_POINT_D65,
                    (float)(200.0f / Math.PI * CamUtils.yFromLstar(50.0f) / 100.0f), 50.0f, 2.0f,
                    false);
        ...
        internal float getNbb()
        {
            return mNbb;
        }

        internal float getNcb()
        {
            return mNcb;
        }
        ...
        internal float getNc()
        {
            return mNc;
        }

        internal float[] getRgbD()
        {
            return mRgbD;
        }

        internal float getFl()
        {
            return mFl;
        }

        internal float getFlRoot()
        {
            return mFlRoot;
        }
        ...
        public static Frame make(float[] whitepoint, float adaptingLuminance,
                float backgroundLstar, float surround, bool discountingIlluminant)
        {
            ...
            float k4 = k * k * k * k;
            float k4F = 1.0f - k4;
            float fl = k4 * adaptingLuminance + 0.1f * k4F * k4F * (float)MathUtils.cbrt(
