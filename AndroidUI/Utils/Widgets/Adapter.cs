...
namespace AndroidUI.Utils.Widgets
{
    ...
    public interface Adapter<T>
    {
         ...
         * {@link android.view.LayoutInflater#inflate(int, android.view.ViewGroup, bool)}
         ...
         */
        View getView(int position, View convertView, View parent);
         ...
         */
        const int IGNORE_ITEM_VIEW_TYPE = -1;
        ...
        const int NO_SELECTION = int.MinValue;
