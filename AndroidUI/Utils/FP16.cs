...
namespace AndroidUI.Utils
{
    ...
    public sealed class FP16
    {
         ...
         * @hide
         */
        public const short EPSILON = 0x1400;
         ...
         * @hide
         */
        public const short MAX_VALUE = 0x7bff;
        /**
         * Smallest positive normal value a half-precision float may have.
         *
         * @hide
         */
        public const short MIN_NORMAL = 0x0400;
        /**
         * Smallest positive non-zero value a half-precision float may have.
         *
         * @hide
         */
        public const short MIN_VALUE = 0x0001;
        /**
         * A Not-a-Number representation of a half-precision float.
         *
         * @hide
         */
        public const short NaN = 0x7e00;
        /**
         ...
         * @hide
         */
        public const short POSITIVE_INFINITY = 0x7c00;
        /**
         * Positive 0 of type half-precision float.
         *
         * @hide
         */
        public const short POSITIVE_ZERO = 0x0000;
