...
namespace AndroidUI
{
    ...
    public class RectF
    {
         ...
         * @hide
         */
        public void printShortString(TextWriter pw)
        {
         ...
         */
        public bool setIntersect(RectF a, RectF b)
        {
         ...
         */
        public bool intersects(float left, float top, float right,
                                  float bottom)
        {
        ...
        {
            dst.set((int)Math.Round(left), (int)Math.Round(top),
