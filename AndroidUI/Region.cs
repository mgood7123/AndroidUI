...
*/
         ...
         */
        public native bool contains(int x, int y)
        {
         ...
         * guarantee that the rectangle is contained by this region.
         */
        public native bool quickContains(int left, int top, int right,
                                            int bottom)
        {
         ...
         * intersect, but returning true is a guarantee that they do not.
         */
        public native bool quickReject(int left, int top, int right, int bottom)
        {
         ...
         * intersect, but returning true is a guarantee that they do not.
         */
        public native bool quickReject(Region rgn)
        {
         ...
         * true if the result of the op is not empty.
         */
        public bool op(Region region, Op op)
        {
