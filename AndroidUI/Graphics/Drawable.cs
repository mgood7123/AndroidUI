...
namespace AndroidUI.Graphics
{
    ...
    */
    public abstract class Drawable
    {
         ...
         * per invocation.
         */
        private bool mSetBlendModeInvoked = false;
         ...
         * per invocation;
         */
        private bool mSetTintModeInvoked = false;
        ...
        {
            mCallback = cb != null ? new WeakReference<Callback>(cb) : null;
        }
         ...
         * @see #setLayoutDirection(int)
         */
        public bool onLayoutDirectionChanged(int layoutDirection)
        {
            return false;
        }
         ...
         */
        virtual public void setTint(int tintColor)
        {
         ...
         * @see #setTintBlendMode(BlendMode)
         */
        virtual public void setTintList(ColorStateList tint) { }
         ...
         * @see #setTintList(ColorStateList)
         */
        virtual public void setTintMode(BlendMode tintMode)
        {
            if (!mSetTintModeInvoked)
            {
                mSetTintModeInvoked = true;
                BlendMode mode = tintMode != null ? tintMode : null;
         ...
         * @see #setTintList(ColorStateList)
         */
        virtual public void setTintBlendMode(BlendMode blendMode)
        {
         ...
         */
        virtual public ColorFilter getColorFilter()
        {
            return null;
        }
         ...
         *
         * @see android.graphics.RenderNode#setProjectBackwards(bool)
         */
         ...
         * @see #setState(int[])
         */
        virtual public bool isStateful()
        {
            return false;
        }
         ...
         * for this drawable.
         */
        virtual public bool hasFocusStateSpecified()
        {
            return false;
        }
        ...
        {
            if (mLevel != level && level >= 0 && level <= 1000)
            {
                mLevel = level;
        ...
        virtual public bool canApplyTheme()
        {
            return false;
        }
         ...
         * @see #getOpacity
         */
        public static PixelFormat resolveOpacity(PixelFormat op1, PixelFormat op2)
        {
            if (op1 == op2)
            {
                return op1;
         ...
         * last state.
         */
        virtual protected bool onStateChange(int[] state)
        {
            return false;
        }
         ...
         * last level.
         */
        virtual protected bool onLevelChange(int level)
        {
            return false;
        }
         ...
         * the bounds.
         */
        virtual protected void onBoundsChange(Rect bounds)
        {
            // Stub method.
        }
         ...
         */
        virtual public void getOutline(Outline outline)
        {
         ...
         */
        virtual public Drawable mutate()
        {
            return this;
        }
         ...
         * @see Drawable#mutate()
         */
        virtual public ConstantState getConstantState()
        {
            return null;
        }
         ...
         * mode.
         */
        protected BlendModeColorFilter updateTintFilter(BlendModeColorFilter tintFilter,
                ColorStateList tint, BlendMode tintMode)
        {
            ...
            {
                return new BlendModeColorFilter(color, tintMode);
            }

            return tintFilter;
        }

        protected BlendModeColorFilter updateBlendModeFilter(BlendModeColorFilter blendFilter,
         ...
         */
        protected static float scaleFromDensity(float pixels, int sourceDensity, int targetDensity)
        {
         ...
         * @return the scaled pixel value for use in target density
         */
        protected static int scaleFromDensity(
                int pixels, int sourceDensity, int targetDensity, bool isSize)
        {
         ...
         * @hide
         */
        internal static BlendMode parseTintMode(BlendMode value, BlendMode defaultMode)
        {
            return defaultMode;
        }
         ...
         * @hide
         */
        public static BlendMode parseBlendMode(BlendMode value, BlendMode defaultMode)
        {
            return defaultMode;
        }
    }
